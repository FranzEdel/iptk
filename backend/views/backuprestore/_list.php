...
<div class="row">
    <div class="col-md-12">
        ...
        kartik\grid\GridView::widget([
            ...
            'hover' => true,
            'panel' => [
                'heading' => '<h3 class="panel-title"> Respaldos de la Base de Datos</h3>',
                'type' => 'primary',
                'showFooter' => false
            ],
            // set your toolbar
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>  Nuevo Respaldo ', ['create'], ['class' => 'btn btn-success create-backup margin-right5'])
                ],
            ],
            'columns' => array(
                [
