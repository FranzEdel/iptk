...
class SiteController extends Controller
{
    ...
    public function actionAntecedentes()
    {
        return $this->render('antecedentes');
    }
    ...
    public function actionObestrategicos()
    {
        return $this->render('obestrategicos');
    }

    public function actionDondetrabajamos()
    {
        return $this->render('dondetrabajamos');
    }

    public function actionNosrelacionamos()
    {
        return $this->render('nosrelacionamos');
    }
